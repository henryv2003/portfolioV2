      ...
      <div className="container mx-auto max-w-5xl">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-center">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Here are some of my projects, each project was carefully crafted with attention to details,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          (
                  ...
                  <div className="p-6">
                    <div className="flex flex-wrap gap-2 mb-4">
                        {project.tags.map((tag) => (
                          <span className="px-2 py-1 text-xl font-medium rounded-full bg-secondary text-secondary-foreground border">
                            {tag}
                          </span>
                        ))}
                    </div>
              ...
              <div className="text-center mt-12">
                  <a href="https://github.com/henryv2003" target="_blank" className="cosmic-button w-fit flex items-center mx-auto gap-2">
