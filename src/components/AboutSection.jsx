        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1  md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h3 className="text-2xl font-semibold">Passioned web developer and tech creator</h3>
                ...
                <p   className="text-muted-foreground">
                  im constantly learning new technologies and techniques to stay updated with the ever-evolving web landscape
                </p>
                        ...
                        <div className="flex items-start gap-4">
                          <div className="p-3 rounded-full bg-primary/10">
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-muted-foreground">Creating Responsive Websites and web applications</p>
                            </div>
                        </div>
                      </div>
                      ...
                      <div className="gradient-border p-6 card-hover">
                        <div className="flex items-start gap-4">
                          ...
                          <div className="text-left">
                                ...
                                <p className="text-muted-foreground">Leading Projects from Conception to completion</p>
                            </div>
                        </div>
                      </div>
                  </div>    
